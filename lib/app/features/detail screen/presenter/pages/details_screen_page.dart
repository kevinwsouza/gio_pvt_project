...
class _DetailsScreenPageState extends State<DetailsScreenPage> {
  ...
  Future<void> _startBluetoothPairing(BuildContext context) async {
    ...
    if (_isScanning) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
            content:
                Text('Já está em andamento um escaneamento de dispositivos.')),
      );
      return;
    }
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
            content: Text(
                'Escaneamento concluído! Selecione um dispositivo para parear.')),
      );
  ...
  Future<void> _connectToDevice(BluetoothDevice device) async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
            content: Text('Conectado ao dispositivo: ${device.platformName}')),
      );
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
