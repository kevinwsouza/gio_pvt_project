...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<LoginController, LoginState>(builder: (context, state) {
      return Scaffold(
        body: Padding(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    suffixIcon: GestureDetector(
                      onTap: () {
                        setState(() {
                          isPasswordVisible = !isPasswordVisible; // Alterna a visibilidade da senha
                        });
                      },
                      child: Icon(
                        isPasswordVisible ? Icons.visibility : Icons.visibility_off,
                        color: isPasswordVisible ? Colors.black : Colors.grey, // Cor dinâmica do ícone
                      ),
                    ),
                    border: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(8.0),
